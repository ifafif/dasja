$(function() {
	...
	new ApexCharts(document.querySelector("#chart_pegawai_jaksa"), e).render();
	e = {
		chart: {
			height: 180,
			type: "radialBar",
	...
	new ApexCharts(document.querySelector("#chart_pegawai_tu"), e).render();
	e = {
		chart: {
			height: 180,
			type: "radialBar",
	...
	new ApexCharts(document.querySelector("#chart_pegawai_fungsional"), e).render();
	e = {
		series: [{
			name: "Orders",
			data: [240, 160, 671, 414, 555, 257, 901, 613, 727, 414, 555, 257]
	...
	// chart 1
	Highcharts.chart('chart_kepeg_jaksa', {
		chart: {
		...
		title: {
			text: 'Jumlah Pegawai Kejaksaan RI : 28.000 Pegawai'
		},
		tooltip: {
			pointFormat: '{series.name}: Pegawai'
		},
		accessibility: {
			point: {
				valueSuffix: 'Pegawai'
	...
	new ApexCharts(document.querySelector("#chart_kepeg_jaksa"), Highcharts).render()
		...
		Highcharts.chart('chart_kepeg_jaksa', {
			...
			title: {
				text: 'Data Kepegawaian Kejaksaan RI'
			},
			tooltip: {
				pointFormat: '{series.name}: Pegawai'
			},
